...
class Restaurant(db.Model):
    ...
    cuisine_tags = db.Column(db.Text, default="")
...
class SpecialDraft(db.Model):
    ...
    tag_keys = db.Column(db.Text, default="")
    primary_tag = db.Column(db.String(40), nullable=True)
    add_on_name = db.Column(db.String(120), nullable=True)
    add_on_price = db.Column(db.String(40), nullable=True)
    add_on_value_text = db.Column(db.String(200), nullable=True)
    recurrence_rule = db.Column(db.String(120), nullable=True)
    recurrence_label = db.Column(db.String(120), nullable=True)
    recurrence_confidence = db.Column(db.String(20), nullable=True)
    featured_rank = db.Column(db.Integer, nullable=True, index=True)
